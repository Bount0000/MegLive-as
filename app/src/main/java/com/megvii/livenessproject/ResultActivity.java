...
import com.megvii.livenessproject.help.FileUtils;
...
//                bestPath = ConUtil.saveJPGFile(this, image_best, "image_best");
    ...
    private void saveSomethings(String delta,Map<String, byte[]> images){
        long t = System.currentTimeMillis();
        FileUtils.saveFile(this,delta.getBytes(),t+"_delta",".txt");
        for (Map.Entry<String, byte[]> entry : images.entrySet()) {
            FileUtils.saveFile(this,entry.getValue(),t+"_"+entry.getKey(),".jpg");
        }
